...
"""autogenerated by genpy from diffbot_msgs/Encoder.msg. Do not edit."""
import codecs
import sys
...
class Encoder(genpy.Message):
  _md5sum = "608278b453add8de9702c9815f58b7b2"
  _type = "diffbot_msgs/Encoder"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(_get_struct_2i().pack(*self.encoders))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      self.encoders = _get_struct_2i().unpack(str[start:end])
      return self
